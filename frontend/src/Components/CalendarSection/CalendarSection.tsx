export default function CalendarSection() {
  return (
    <div className="w-full bg-stone-100 p-8 rounded-2xl mt-4">
      <div className="flex flex-row justify-center w-full">
        <span className="font-medium mr-2 text-lg">
          Your pick-up date is on the <span className="font-black">25th of March</span> at the address you provided in
          St. Gallen
        </span>
      </div>
      ...
      <div className="flex flex-row justify-center w-full">
        <span className="font-medium mr-2 text-lg">Receive a text message reminder</span>
      </div>

      <div className="flex flex-row justify-center items-center mt-4 w-64 mx-auto">
        <input
          type="tel"
          id="phone"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
          placeholder="+411112345675"
          required
        />
      </div>
    </div>
