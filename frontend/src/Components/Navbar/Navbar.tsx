export default function Navbar() {
  return (
    <nav className="p-3 border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700 mb-12">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <a href="#" className="flex items-center">
          <img
            src="https://www.energieagentur-sg.ch/demandit/files/M_BA650995FEF8076B577/dms/Image/20160809_Logo_st_gallen_4c.png"
            className="h-6 mr-3 sm:h-9 mt-2"
          />
        </a>
        <button
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul className="flex flex-col mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
            <li>
              <a
                href="#"
                className="block py-2 pl-3 pr-4 text-white bg-red-700 rounded md:bg-transparent md:text-red-700 md:p-0 md:dark:text-white dark:bg-red-600 md:dark:bg-transparent"
                aria-current="page"
              >
                Home
              </a>
